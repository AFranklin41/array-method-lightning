...
// const studentsFilterThing = studentData.filter(singleStudent => singleStudent.firstName.startsWith("J"))
// console.log(studentsFilterThing)

const namesArray = studentData.map(singleStudent => `${singleStudent.firstName}`) 
console.log(namesArray)

const sentenceArray = studentData.map(singleStudent =>{
	return {
		fullName: `${singleStudent.firstName}`,
		aboutSentence: `${singleStudent.firstName} loves ${singleStudent.favoriteFood}`
	}
})
...
const rainfallThing = monthlyRainfall.reduce((squished, currentThing) => squished += currentThing)

console.log(rainfallThing)
...
// 	const studentLoopedNames = `${studentName.firstName} ${studentName.lastName}`
// 	console.log(`${studentLoopedNames}'s favorite food is ${studentName.favoriteFood}!`)
// })
...
// 	console.log(`${business.purchasingAgent.nameFirst} ${business.purchasingAgent.nameLast} is the purchasing agent for ${business.companyName}, which is a ${business.companyIndustry} company. `)
// })
